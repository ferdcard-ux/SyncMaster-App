...
class SettingsDialog(QDialog):
    def __init__(self, config_manager, parent=None):
        ...
        self.setStyleSheet(
            ...
            "QTabBar::tab { min-height: 28px; padding: 8px 12px; }"
            "QTabBar::tab:hover { background-color: #e6f2ea; }"
            "QTabBar::tab:selected { background-color: #f5fff9; border-bottom: 2px solid #2f7a3a; }"
        )
        self.setup_ui()
        self.load_settings()
