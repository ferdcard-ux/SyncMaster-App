...
echo "Building SyncMaster v$VERSION..."
...
mkdir -p AppDir/managers AppDir/ui AppDir/core AppDir/assets
cp managers/*.py AppDir/managers/
cp ui/*.py AppDir/ui/
cp core/*.py AppDir/core/
...
[Desktop Entry]
Type=Application
Name=Sync Master v$VERSION Private
Exec=python3 main.py %u
Icon=sync-master
Categories=Utility;
X-AppImage-Name=Sync Master v$VERSION Private
Terminal=false
EOF
...
mv SyncMaster-x86_64.AppImage SyncMaster-v$VERSION-Private.AppImage

echo "Done: SyncMaster-v$VERSION-Private.AppImage created."
