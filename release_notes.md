## [1.6.2] - 2026-03-27
### Fixed
- **Hotfix de Lanzamiento**: Se movieron los logs y filtros a `~/.config/sync_master/` para permitir la ejecución desde el AppImage (FUSE) sin errores de permisos de escritura.
