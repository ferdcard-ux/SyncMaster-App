...
class AutostartManager(QObject):
    def __init__(self):
        """Initialize AutostartManager with the XDG autostart directory path."""
        super().__init__()
    ...
    def is_enabled(self):
        ...
        Returns:
            True if the desktop entry file exists.
        """
        return os.path.exists(self.desktop_file)

    def set_enabled(self, enabled):
        """Enable or disable system autostart.

        Args:
            enabled: True to enable autostart, False to disable it.
        """
        if enabled:
            self.enable()
        else:
    ...
    def enable(self):
        """Create a .desktop file in the XDG autostart directory."""
...
"""
    ...
    def disable(self):
        """Remove the .desktop file to disable system autostart."""
