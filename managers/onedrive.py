...
class OneDriveManager(QObject):
    ...
    def configure_onedrive(self, local_path, remote_folder):
        ...
        return ["onedrive", "--sync", "--confdir", base_config_dir, "--verbose", "--disable-notifications", "--force", "--force-http-11"]
    ...
    def sync(self):
        ...
        try:
            self.current_cmd = self.configure_onedrive(self.local_dir, remote_dir)
